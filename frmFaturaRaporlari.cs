...
namespace GPTS
{
    public partial class frmFaturaRaporlari : DevExpress.XtraEditors.XtraForm
    {
        public frmFaturaRaporlari()
        {
            InitializeComponent();
        ...
        void Satislar()
        {
            string sql = "sp_FisBazindaSatisRaporu2 @ilktar,@sontar";
...
list.Add(new SqlParameter("@sontar", sontarih.DateTime.ToString("yyyy-MM-dd HH:mm:59")));
        ...
        void Satislar_ayrintili2()
        {
            string sql = @"SELECT  Satislar.GuncellemeTarihi,Satislar.pkSatislar,StokKarti.pkStokKarti,StokKarti.Barcode, StokKarti.Stokadi, 
                      ...
                      WHERE Satislar.fkSatisDurumu=11 and Satislar.Siparis=1 AND
                      ((Satislar.FaturaTarihi>=@ilktar AND Satislar.FaturaTarihi<=@sontar) or Satislar.FaturaTarihi is null)";
...
where s.pkSatislar =" + pkSatislar;
        ...
        private void gridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (pkSatislar != "")
            {
                ...
                FisNoBilgisi.fisno.Text = pkSatislar;
