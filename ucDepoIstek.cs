...
namespace GPTS
{
    ...
    public partial class ucDepoIstek : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ucAnaEkran_Load(object sender, EventArgs e)
        {
            ...
            string Dosya = DB.exeDizini + "\\DepoIstek.xml";
        ...
        void IstekDurumlari()
        {
            lueIstekDurumlari.Properties.DataSource = DB.GetData("select * from IstekDurumlari  with(nolock) where aktif=1 ");
            lueIstekDurumlari.EditValue = 0;//int.Parse(DB.fkKullanicilar);
        }
        ...
        private void simpleButton3_Click(object sender, EventArgs e)
        {
            ...
            int sonuc = 0;
            string pkSatislar = "0";// Satis1Toplam.Tag.ToString();
...
//            where SatisDetay.fkStokKarti=sk.pkStokKarti and  pkSatisDetay=" + dr["pkSatisDetay"].ToString());
        ...
        void YeniDepoTransfer()
        {
            ...
            list.Add(new SqlParameter("@aciklama", textEdit1.Text));
