...
namespace GPTS
{
    public partial class frmTeklifRaporlari : DevExpress.XtraEditors.XtraForm
    {
        public frmTeklifRaporlari()
        {
            InitializeComponent();
        ...
        private void ucSatislar_Load(object sender, EventArgs e)
        {
            ...
            //dizayn
            string Dosya = DB.exeDizini + "\\TeklifRaporlariGrid.xml";
        ...
        void Teklifler()
        {
            string sql = "sp_FisBazindaTeklifRaporu @ilktar,@sontar";
...
list.Add(new SqlParameter("@sontar", sontarih.DateTime.ToString("yyyy-MM-dd HH:mm:59")));
        ...
        void Teklifler_ayrintili()
        {
            string sql = @"exec sp_FisBazindaTeklifRaporu_Ayrintili @ilktar,@sontar";
            ArrayList list = new ArrayList();
            list.Add(new SqlParameter("@ilktar", ilktarih.DateTime.ToString("yyyy-MM-dd HH:mm:00")));
            list.Add(new SqlParameter("@sontar", sontarih.DateTime.ToString("yyyy-MM-dd HH:mm:59")));
        ...
        void Teklifler_ayrintili2()
        {
            string sql = @"SELECT  Satislar.GuncellemeTarihi,Satislar.pkSatislar,StokKarti.pkStokKarti,StokKarti.Barcode, StokKarti.Stokadi, 
                      ...
                      WHERE Satislar.Siparis = 1 AND Satislar.fkSatisDurumu=1 AND Satislar.GuncellemeTarihi>=@ilktar AND Satislar.GuncellemeTarihi<=@sontar";
            ArrayList list = new ArrayList();
            list.Add(new SqlParameter("@ilktar", ilktarih.DateTime.ToString("yyyy-MM-dd HH:mm:00")));
            list.Add(new SqlParameter("@sontar", sontarih.DateTime.ToString("yyyy-MM-dd HH:mm:59"))); 
        ...
        void Teklifler_Kullanicibazinda()
        {
...
group by k.KullaniciAdi,k.adisoyadi,sd.Durumu";//convert(date,Satislar.GuncellemeTarihi),
        ...
        private void simpleButton1_Click_1(object sender, EventArgs e)
        {
            if (xtraTabControl1.SelectedTabPageIndex == 0)
                ...
                Teklifler_ayrintili2();
            else if (xtraTabControl1.SelectedTabPageIndex == 3)
                Teklifler_Kullanicibazinda();
        }
